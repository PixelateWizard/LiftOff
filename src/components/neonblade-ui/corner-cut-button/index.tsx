...
const SIZE_STYLES: Record<CCBSize, React.CSSProperties> = {
  xs: { padding: "8px 16px", fontSize: 12 },
        ...
        style={{
          ...
          background:
            variant === "solid"
              ...
              : variant === "outline"
              ? "#000"
              : "color-mix(in srgb, var(--ccb-color) 12%, #000)",
          color:
            resolvedTextColor ??
            (variant === "solid" ? "#000" : "var(--ccb-color)"),
          ...SIZE_STYLES[size],
          ...ghostStyle,
