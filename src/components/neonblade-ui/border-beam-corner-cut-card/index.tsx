...
export interface BorderBeamCornerCutCardProps extends HTMLAttributes<HTMLDivElement> {
  ...
  /** Inline styles applied to the inner content div. Useful outside Tailwind apps. */
...
const INNER_PADDING_STYLE: Record<BBCSize, string> = {
  sm: "1.25rem",
  md: "1.5rem",
  lg: "2rem",
  xl: "2.5rem",
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          padding: INNER_PADDING_STYLE[size],
          backgroundColor: bgColor ?? "var(--background, #050505)",
          ...innerStyle,
        }}
      >
        {icon && (
