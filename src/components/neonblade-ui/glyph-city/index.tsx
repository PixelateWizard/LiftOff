...
export function GlyphCity({
  ...
  return (
    <div
      className={className ?? ""}
      style={{ position: "absolute", inset: 0, width: "100%", height: "100%", overflow: "hidden", background: bgColor }}
    >
      <canvas
        ref={canvasRef}
        style={{ width: "100%", height: "100%", pointerEvents: "none", opacity: opacity / 100 }}
      />
    </div>
  );
}
