...
export const CyberCircuit: React.FC<CyberCircuitProps> = ({
  ...
  return (
    ...
    >
      {/* Top Left Corner */}
      <svg
        style={{ position: "absolute", top: 0, left: 0, width: "clamp(10rem,26vw,24rem)", height: "clamp(10rem,26vw,24rem)" }}
        viewBox="0 0 200 200"
        fill="none"
      ...
      {/* Bottom Right Corner */}
      <svg
        style={{ position: "absolute", bottom: 0, right: 0, width: "clamp(10rem,26vw,24rem)", height: "clamp(10rem,26vw,24rem)" }}
        viewBox="0 0 200 200"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      {/* Top Right Corner */}
      <svg
        style={{ position: "absolute", top: 0, right: 0, width: "clamp(8rem,20vw,18rem)", height: "clamp(8rem,20vw,18rem)" }}
        viewBox="0 0 200 200"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      {/* Bottom Left Corner */}
      <svg
        style={{ position: "absolute", bottom: 0, left: 0, width: "clamp(8rem,20vw,18rem)", height: "clamp(8rem,20vw,18rem)" }}
        viewBox="0 0 200 200"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
