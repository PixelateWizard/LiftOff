...
export const DEFAULT_SETTINGS = {
  ...
  tabbar_show_buttons: "tabbar", tabbar_text_tabs: true, tabbar_with_background: false, tabbar_background_compact: false, tabbar_font_weight: "medium", tabbar_icon_mode: "text",
