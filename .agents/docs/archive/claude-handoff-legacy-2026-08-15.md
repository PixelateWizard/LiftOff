# Frozen Legacy Handoff — 2026-08-15

> **Archive only. Do not read this file during normal task startup.** This is the complete pre-migration `CLAUDE.md` snapshot preserved for historical investigations. Its instructions, paths, and implementation details may be stale. Start with the repository-root `CLAUDE.md` and `.agents/docs/README.md`, then inspect current source code.
