...
- Connected account rows require explicit action focus before activation. Left/Right moves among visible buttons without invoking them; Microsoft orders Refresh before Disconnect, while Steam and Spotify focus Disconnect. Enter/A on the row first enters its action focus so ordinary horizontal navigation cannot sign an account out.
