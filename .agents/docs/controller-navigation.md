...
- The helper tray and Controls modal own their keyboard/gamepad loops while visible and gate the app poll through mirrored refs. MENU tap remains tab-specific, while an 850 ms MENU hold opens the helper tray on every tab regardless of Spotify state.
